      ...
      <div className="w-full max-w-4xl mx-auto bg-gray-200  p-6 text-center">
        ...
        <div className="space-y-6">
          <p className="text-base sm:text-lg md:text-2xl text-black font-[Open Sans] leading-relaxed">
            ...
            Spirit-filled community where people from all walks of life can
            encounter the transformative love of Jesus Christ. We are committed
            to cultivating an atmosphere of worship, fellowship, and spiritual
