export default function OurLeader() {
  return (
    <section className="bg-gray-200  w-full">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center max-w-full mx-auto bg-gray-200  shadow-lg p-10">
        {/* Pastor Image */}
        <img
        ...
        <div className="text-center md:text-left">
          <h3 className="text-7xl font-bold text-black mb-4">
            Pastor M.E Maudu
          </h3>
          <p className="text-2xl text-black font-[Open Sans] leading-relaxed max-w-xl">
