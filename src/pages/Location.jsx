export default function Location() {
  return (
    <main className="w-full min-h-screen bg-gray-100 py-12 sm:py-16 px-4 sm:px-6">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-8 sm:mb-10 text-gray-900">
        Find Us
      </h1>
